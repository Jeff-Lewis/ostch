...
@partners.each do |p|
    for i in 0..20
        ...
        #User
        @customer = Customer.where('user_id=? and partner_id=?', ura1,p.id)
        if @customer.count == 0
            customers = Customer.create({user_id:ura1, partner_id: p.id, customer_number:"Kunden-Nr PK5962356326"+i.to_s})
        ...
        # Companies
        @customer = Customer.where('company_id=? and partner_id=?', cra1,p.id)
        if @customer.count == 0
            customers = Customer.create({company_id:cra1, partner_id: p.id, customer_number:"Kunden-Nr FK5962356326"+i.to_s})
...
if @comp
    for i in 2..5    
        partnerlinks = PartnerLink.create({active:true, company_id: @comp.id, name:"eBanking", link:"www.tkb.ch/ebanking", avatar:File.open(path+'TKB0'+i.to_s+'.tiff', 'rb')})
    end
end
...
@cfs.each do |c|
    ...
    for i in 1..20
        ...
        mstats = Mstat.create({mobject_id: c.id, user_id: ura1, amount:100, created_at:Date.today-dat})
...
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"2.10.2005", anonymous:false, status:"ok", active:true, email:"anton.meier@outlook.com", password:"password", name:"Anton", lastname:"Meier", address1:"Im Roos", address2:"Weinfelden", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.9.2007", anonymous:false, status:"ok", active:true, email:"e.oschewsky@bluewin.ch", password:"password", name:"Emelie", lastname:"Oschewsky", address1:"Hörnliblick 11", address2:"Zezikon", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"11.5.1963", anonymous:false, status:"ok", active:true, email:"henning.gebert@outlook.com", password:"password", name:"Henning", lastname:"Gebert", address1:"Bahnhof", address2:"Pfäffikon SZ", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"1.5.1970", anonymous:false, status:"ok", active:true, email:"heidi.hirsch@outlook.ch", password:"password", name:"Heidi", lastname:"Hirsch", address1:"Hauptstrasse 1", address2:"Amlikon", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"14.4.2003", anonymous:false, status:"ok", active:true, email:"fred.gautschi@bluewin.ch", password:"password", name:"Fred", lastname:"Gautschi", address1:"Dorfplatz 1", address2:"Matzingen", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"6.3.2004", anonymous:false, status:"ok", active:true, email:"christian.meier@gmx.com", password:"password", name:"Christian", lastname:"Meier", address1:"Alte Wilderenstrasse 4", address2:"Zezikon", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.12.2008", anonymous:false, status:"ok", active:true, email:"barak@outlook.com", password:"password", name:"Barak", lastname:"Obama", address1:"Marktplatz", address2:"Frauenfeld", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"26.4.2009", anonymous:false, status:"ok", active:true, email:"trump@bluewin.ch", password:"password", name:"Donald", lastname:"Trump", address1:"Hauptstrasse 1", address2:"Buch", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.7.2010", anonymous:false, status:"ok", active:true, email:"angela@outlook.com", password:"password", name:"Angela", lastname:"Merkel", address1:"Bahnhof", address2:"Wil SG", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.7.1970", anonymous:false, status:"ok", active:true, email:"kurt.felix@outlook.com", password:"password", name:"Kurt", lastname:"Felix", address1:"Vadianstrasse 8", address2:"St Gallen", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.7.1969", anonymous:false, status:"ok", active:true, email:"pierin.claglüna@outlook.com", password:"password", name:"Pierin", lastname:"Claglüna", address1:"Bahnhof", address2:"Chur", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.7.1958", anonymous:false, status:"ok", active:true, email:"gregor.stuecheli@outlook.com", password:"password", name:"Gregor", lastname:"Stücheli", address1:"Bahnhof", address2:"Münchwilen", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"hans.nagel@outlook.com", password:"password", name:"Hans", lastname:"Nagel", address1:"Amriswil", address2:"Hauptstrasse 2", address3:"", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"corinne@outlook.com", password:"password", name:"Corinne", lastname:"Iaonnidis-Sondereggert", address1:"Marktstrasse 26", address2:"Weinfelden", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"christoph@outlook.com", password:"password", name:"Christoph", lastname:"Sprenger", address1:"Marktstrasse 26", address2:"Bisseg", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"aron@outlook.com", password:"password", name:"Aron", lastname:"Gamba", address1:"Marktstrasse 26", address2:"Amlikon", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"fabio@outlook.com", password:"password", name:"Fabio", lastname:"Tauro", address1:"Marktstrasse 26", address2:"Busnang", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"isabelle@outlook.com", password:"password", name:"Isabelle", lastname:"Hugentobler", address1:"Marktstrasse 26", address2:"Weinfelden", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"marco@outlook.com", password:"password", name:"Marco", lastname:"Sonderegger", address1:"Marktstrasse 26", address2:"Kreuzlingen", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"melanie@outlook.com", password:"password", name:"Melanie", lastname:"Forster", address1:"Marktstrasse 26", address2:"Frauenfeld", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"nunzia@outlook.com", password:"password", name:"Nunzia", lastname:"Seiler", address1:"Marktstrasse 26", address2:"Matzingen", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"oliverp@outlook.com", password:"password", name:"Oliver", lastname:"Paulin", address1:"Marktstrasse 26", address2:"Wängi", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"petrak@outlook.com", password:"password", name:"Petra", lastname:"Koch", address1:"Marktstrasse 26", address2:"Wil", address3:"St.Gallen", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"rschaelchi@outlook.com", password:"password", name:"Raymond", lastname:"Schaelchli", address1:"Marktstrasse 26", address2:"Effretikon", address3:"Zürich", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"rschoch@outlook.com", password:"password", name:"Remo", lastname:"Schoch", address1:"Marktstrasse 26", address2:"Ebmatingen", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"sherzog@outlook.com", password:"password", name:"Stefanie", lastname:"Herzog", address1:"Marktstrasse 26", address2:"Stettfurt", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"vkirli@outlook.com", password:"password", name:"Vesile", lastname:"Kirli", address1:"Marktstrasse 26", address2:"Lommis", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"mbueschl@outlook.com", password:"password", name:"Manuela", lastname:"Bueschl", address1:"Marktstrasse 26", address2:"Bronschhofen", address3:"St.Gallen", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"ppreite@outlook.com", password:"password", name:"Patric", lastname:"Preite", address1:"Marktstrasse 26", address2:"Weinfelden", address3:"Thurgau", superuser:false})
users = User.create({calendar:true, time_from:8, time_to:20, dateofbirth:"12.5.1967", anonymous:false, status:"ok", active:true, email:"rruckstuhl@outlook.com", password:"password", name:"Ramona", lastname:"Ruckstuhl", address1:"Marktstrasse 26", address2:"Weinfelden", address3:"Thurgau", superuser:false})
#create some appointments
usanz = User.all.count-1
random = Random.new(Time.new.to_i)
for i in 0..300
...
companies = Company.create({status:"ok", active:true, user_id:4, name:"Prematic", mcategory_id:12 ,stichworte: "Luftdruck", address1:"Bahnhof", address2:"Wängi", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:5, name:"Baufirma Meier", mcategory_id:11 ,stichworte: "Hocbau, Tiefbau", address1:"Hauptstrasse", address2:"Zezikon", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:5, name:"Lackierwerkstatt Manser", mcategory_id:9 ,stichworte: "Karosserie", address1:"Amlikon", address2:"Haupstrasse", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:6, name:"Malermeister Painter", mcategory_id:10 ,stichworte: "Malerarbeiten", address1:"Gartenstrasse 2", address2:"Lommis", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:7, name:"Tierschutzbund Weinfelden", mcategory_id:25 ,stichworte: "Tiere", address1:"Gartenstrasse 2", address2:"Lommis", address3:"Thurgau", social:true}) 
companies = Company.create({status:"ok", active:true, user_id:8, name:"Blindenverein Wängi", mcategory_id:9 ,stichworte: "Verein", address1:"Wängi", address2:"Haupstrasse", address3:"Thurgau", social:true}) 
companies = Company.create({status:"ok", active:true, user_id:9, name:"Kosmetikstudio Jasmine", mcategory_id:10 ,stichworte: "Kosmetik", address1:"Gartenstrasse 2", address2:"Bürglen", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:10, name:"Autohaus Hummel", mcategory_id:25 ,stichworte: "Auto KFZ", address1:"Hauptstrasse", address2:"Bissegg", address3:"Thurgau"}) 
companies = Company.create({status:"ok", active:true, user_id:11, name:"Valiant Bank", mcategory_id:26 ,stichworte: "Bank Finanz Geld", address1:"Bahnhof", address2:"Bern", address3:"Bern"}) 
companies = Company.create({status:"ok", active:true, user_id:12, name:"St.Galler Kantonalbank", partner:true, mcategory_id:26 ,stichworte: "Banken", address1:"Bahnhof", address2:"St.Gallen", address3:"St.gallen"}) 
companies = Company.create({status:"ok", active:true, user_id:14, name:"Graubündner Kantonalbank", partner:true, mcategory_id:26 ,stichworte: "Banken", address1:"Bahnhof", address2:"Chur", address3:"Graubünden"}) 
companies = Company.create({status:"ok", active:true, user_id:14, name:"Sonderegger publish", partner:false, mcategory_id:22 ,stichworte: "Copyshop Drucken Druckerei Publish Webdesign", address1:"Marktstrasse 26", address2:"8570 Weinfelden", address3:"Thurgau"}) 
