...
class UserTicketsControllerTest < ActionController::TestCase
  ...
  test "should create user_ticket" do
    assert_difference('UserTicket.count') do
      post :create, user_ticket: { status: @user_ticket.status, ticket_id: @user_ticket.ticket_id, user_id: @user_ticket.user_id }
    end
  ...
  test "should update user_ticket" do
    patch :update, id: @user_ticket, user_ticket: { status: @user_ticket.status, ticket_id: @user_ticket.ticket_id, user_id: @user_ticket.user_id }
    assert_redirected_to user_ticket_path(assigns(:user_ticket))
  end
