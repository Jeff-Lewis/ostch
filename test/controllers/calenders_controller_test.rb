...
class CalendersControllerTest < ActionController::TestCase
  ...
  test "should create calender" do
    assert_difference('Calender.count') do
      post :create, calender: { date_from: @calender.date_from, date_to: @calender.date_to, user_id: @calender.user_id, vehicle_id: @calender.vehicle_id }
    end
  ...
  test "should update calender" do
    patch :update, id: @calender, calender: { date_from: @calender.date_from, date_to: @calender.date_to, user_id: @calender.user_id, vehicle_id: @calender.vehicle_id }
    assert_redirected_to calender_path(assigns(:calender))
  end
