...
class AccessesControllerTest < ActionController::TestCase
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post :create, access: { access: @access.access, costrate: @access.costrate, user_id: @access.user_id, workorder_id: @access.workorder_id }
    end
  ...
  test "should update access" do
    patch :update, id: @access, access: { access: @access.access, costrate: @access.costrate, user_id: @access.user_id, workorder_id: @access.workorder_id }
    assert_redirected_to access_path(assigns(:access))
  end
