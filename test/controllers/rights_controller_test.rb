...
class RightsControllerTest < ActionController::TestCase
  ...
  test "should create right" do
    assert_difference('Right.count') do
      post :create, right: { company_id: @right.company_id, superuser: @right.superuser, user_id: @right.user_id }
    end
  ...
  test "should update right" do
    patch :update, id: @right, right: { company_id: @right.company_id, superuser: @right.superuser, user_id: @right.user_id }
    assert_redirected_to right_path(assigns(:right))
  end
